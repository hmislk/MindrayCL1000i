...
public class MindrayCL1000i {
    ...
    private static MindrayCL1000iServer server = new MindrayCL1000iServer(); // Make the server instance static for restart
    ...
    public static void main(String[] args) {
        ...
        server = new MindrayCL1000iServer();
        server.start(port);
    }
    ...
    public static void restartServer() {
        ...
        try {
            ...
            server = new MindrayCL1000iServer(); // Create a new instance of the server
            server.start(port);
